...
'*now':function(r){r(['dojo/i18n!*preload*lib/nls/dialog-dependencies*["ar","ca","cs","da","de","el","en-gb","en-us","es-es","fi-fi","fr-fr","he-il","hu","it-it","ja-jp","ko-kr","nl-nl","nb","pl","pt-br","pt-pt","ru","sk","sl","sv","th","tr","zh-tw","zh-cn","ROOT"]']);}
}});
define("lib/dialog-dependencies", [
    'dijit/Dialog',
    'dijit/form/TextBox',
    'dijit/form/Button'
], function () {});
